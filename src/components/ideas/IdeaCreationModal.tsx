        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.hackathonId} onValueChange={(value) => 
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) => setFormData(prev => ({ ...prev, isLongRunning: checked }))}
            />
            <Label htmlFor="longRunning">Long-running project (extends beyond hackathon)</Label>
          </div>
