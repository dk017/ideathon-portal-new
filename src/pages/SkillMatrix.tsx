        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Ideas Using Skills</p>
              ...
              <CardContent>
                ...
                {selectedSkill === skill && (
                  <div className="mt-4 pt-4 border-t space-y-3">
                    <div>
                      <h4 className="font-medium text-sm text-gray-900 mb-2">Users ({skillUsers.length})</h4>
                    ...
                    <div>
                      <h4 className="font-medium text-sm text-gray-900 mb-2">Ideas ({skillIdeas.length})</h4>
                      <div className="space-y-1">
